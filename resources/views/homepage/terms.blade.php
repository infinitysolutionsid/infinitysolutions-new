    ...
    <div class="slide kenburns" style="background-image:url('{!!asset('storage/bg/parallax-1.jpg')!!}');">
        ...
        <div class="container">
            <div class="slide-captions text-center text-light">
                ...
                <span class="strong">Important Link</span>
...
<section>
    <div class="container">
        ...
        <p>Welcome to Infinity Solutions!</p>
        <p>These terms and conditions outline the rules and regulations for the use of PT BENUA SOLUSI TEKNOLOGI's
            Website, located at https://www.infinitysolutions.co.id.</p>
        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Infinity
            Solutions if you do not agree to take all of the terms and conditions stated on this page. Our Terms and
            Conditions were created with the help of the <a href="https://termsandconditionsgenerator.com">Terms And
                Conditions Generator</a> and the <a href="https://privacy-policy-template.com">Privacy Policy
                Template</a>.</p>
        ...
        <p>We employ the use of cookies. By accessing Infinity Solutions, you agreed to use cookies in agreement with
            the PT BENUA SOLUSI TEKNOLOGI's Privacy Policy.</p>
        ...
        <p>Unless otherwise stated, PT BENUA SOLUSI TEKNOLOGI and/or its licensors own the intellectual property rights
            for all material on Infinity Solutions. All intellectual property rights are reserved. You may access this
            from Infinity Solutions for your own personal use subjected to restrictions set in these terms and
            conditions.</p>
        <p>You must not:</p>
        <ul>
            <li>Republish material from Infinity Solutions</li>
            <li>Sell, rent or sub-license material from Infinity Solutions</li>
            <li>Reproduce, duplicate or copy material from Infinity Solutions</li>
            <li>Redistribute content from Infinity Solutions</li>
        </ul>
        <p>This Agreement shall begin on the date hereof.</p>
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. PT BENUA SOLUSI TEKNOLOGI does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and opinions of PT BENUA SOLUSI
            TEKNOLOGI,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their
            views and opinions. To the extent permitted by applicable laws, PT BENUA SOLUSI TEKNOLOGI shall not be
            liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any
            use of and/or posting of and/or appearance of the Comments on this website.</p>
        <p>PT BENUA SOLUSI TEKNOLOGI reserves the right to monitor all Comments and to remove any Comments which can be
        ...
        <p>You hereby grant PT BENUA SOLUSI TEKNOLOGI a non-exclusive license to use, reproduce, edit and authorize
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of PT
            BENUA SOLUSI TEKNOLOGI; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to PT BENUA SOLUSI TEKNOLOGI. Please include your name, your
        ...
        <p>No use of PT BENUA SOLUSI TEKNOLOGI's logo or other artwork will be allowed for linking absent a trademark
            license agreement.</p>
