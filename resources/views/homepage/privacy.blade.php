...
<section>
    <div class="container">
        ...
        <p>Infinity Solutions ("us", "we", or "our") operates the https://infinitysolutions.co.id website
            (hereinafter
        ...
        <p>This page informs you of our policies regarding the collection, use, and disclosure of personal
            data when you
            use our Service and the choices you have associated with that data. Our Privacy Policy for
            Infinity
            Solutions is created with the help of the <a
                href="https://privacypolicies.com/privacy-policy-generator/">PrivacyPolicies.com Privacy
                Policy
                Generator</a>.</p>
        <p>We use your data to provide and improve the Service. By using the Service, you agree to the
            ...
            accessible from
            https://infinitysolutions.co.id</p>
        ...
        <p>Cookies are files with small amount of data which may include an anonymous unique identifier.
            Cookies are
            sent to your browser from a website and stored on your device. Tracking technologies also used
            are beacons,
        ...
        <p>You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent.
            However, if
            you do not accept cookies, you may not be able to use some portions of our Service. You can
            learn more how
        ...
        <h2>Use of Data</h2>
        <p>Infinity Solutions uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>If you are located outside Indonesia and choose to provide information to us, please note that we
            transfer
            the data, including Personal Data, to Indonesia and process it there.</p>
        <p>Your consent to this Privacy Policy followed by your submission of such information represents
            your agreement
            to that transfer.</p>
        <p>Infinity Solutions will take all steps reasonably necessary to ensure that your data is treated
            securely and
        ...
        <p>Infinity Solutions may disclose your Personal Data in the good faith belief that such action is
            necessary to:
        </p>
        <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Infinity Solutions</li>
        ...
        <ul>
            <li>
                ...
                <p>Google Analytics is a web analytics service offered by Google that tracks and reports
                    website
                    traffic. Google uses the data collected to track and monitor the use of our Service.
                    This data is
        ...
        <ul>
            <li>By visiting this page on our website: https://infinitysolutions.co.id/about-us</li>
        </ul>
    </div>
</section>
@endsection
